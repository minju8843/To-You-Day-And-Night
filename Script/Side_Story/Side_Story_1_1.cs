...
public class GameData_Side_Story_1_1
...
public class Side_Story_1_1 : MonoBehaviour
{
    ...
    public Player_N_1_1 player_name;
    ...
    private void Side_Story_What_Page_LoadSettings()
    {
        ...
        if (PlayerPrefs.HasKey("SideStory_1_1_What_Page"))
        {
            string What_Page_First_Page_jsonData_1 = PlayerPrefs.GetString("SideStory_1_1_What_Page");
            GameData_Side_Story_1_1 What_Page_First_Page_data_1 = JsonUtility.FromJson<GameData_Side_Story_1_1>(What_Page_First_Page_jsonData_1);
    ...
    private void Side_Story_1_SaveSettings()//일단 첫 번째 사이드 스토리의 몇 번째인지(1, 1-1, 1-2중)
    {
        ...
        GameData_Side_Story_1_1 data = new GameData_Side_Story_1_1();
        data.First_Side_Story = First_Side_Story_Object_Index;

        string jsonData = JsonUtility.ToJson(data);
        PlayerPrefs.SetString("SideStory_1_1", jsonData);
        PlayerPrefs.Save();


        //여기부터는 첫 번째 이야기의 몇 번째 페이지에서 저장했는지
        GameData_Side_Story_1_1 What_Page_First_Page_data_1 = new GameData_Side_Story_1_1();
        ...
        PlayerPrefs.SetString("SideStory_1_1_What_Page", What_Page_First_Page_jsonData_1);
        PlayerPrefs.Save();
        ...
        //5번 페이지
        GameData_Side_Story_1_1 Page_5_Text_data = new GameData_Side_Story_1_1();
        Page_5_Text_data.Page_5_Index = Page_Count_5;

        string Page_5_Text_jsonData = JsonUtility.ToJson(Page_5_Text_data);
        PlayerPrefs.SetString("Page_5_1_Text", Page_5_Text_jsonData);
        PlayerPrefs.Save();

        //6번
        GameData_Side_Story_1_1 Page_6_Text_data = new GameData_Side_Story_1_1();
        Page_6_Text_data.Page_6_Index = Page_Count_6;

        string Page_6_Text_jsonData = JsonUtility.ToJson(Page_6_Text_data);
        PlayerPrefs.SetString("Page_6_1_Text", Page_6_Text_jsonData);
        PlayerPrefs.Save();

        //7번
        GameData_Side_Story_1_1 Page_7_Text_data = new GameData_Side_Story_1_1();
        Page_7_Text_data.Page_7_Index = Page_Count_7;

        string Page_7_Text_jsonData = JsonUtility.ToJson(Page_7_Text_data);
        PlayerPrefs.SetString("Page_7_1_Text", Page_7_Text_jsonData);
        PlayerPrefs.Save();

        //8번
        GameData_Side_Story_1_1 Page_8_Text_data = new GameData_Side_Story_1_1();
        Page_8_Text_data.Page_8_Index = Page_Count_8;

        string Page_8_Text_jsonData = JsonUtility.ToJson(Page_8_Text_data);
        PlayerPrefs.SetString("Page_8_1_Text", Page_8_Text_jsonData);
        PlayerPrefs.Save();

        //9번
        GameData_Side_Story_1_1 Page_9_Text_data = new GameData_Side_Story_1_1();
        Page_9_Text_data.Page_9_Index = Page_Count_9;

        string Page_9_Text_jsonData = JsonUtility.ToJson(Page_9_Text_data);
        PlayerPrefs.SetString("Page_9_1_Text", Page_9_Text_jsonData);
        PlayerPrefs.Save();

        //10번 페이지
        GameData_Side_Story_1_1 Page_10_Text_data = new GameData_Side_Story_1_1();
        Page_10_Text_data.Page_10_Index = Page_Count_10;

        string Page_10_Text_jsonData = JsonUtility.ToJson(Page_10_Text_data);
        PlayerPrefs.SetString("Page_10_1_Text", Page_10_Text_jsonData);
        PlayerPrefs.Save();

        //11번
        GameData_Side_Story_1_1 Page_11_Text_data = new GameData_Side_Story_1_1();
        Page_11_Text_data.Page_11_Index = Page_Count_11;

        string Page_11_Text_jsonData = JsonUtility.ToJson(Page_11_Text_data);
        PlayerPrefs.SetString("Page_11_1_Text", Page_11_Text_jsonData);
        PlayerPrefs.Save();

        //12번
        GameData_Side_Story_1_1 Page_12_Text_data = new GameData_Side_Story_1_1();
        Page_12_Text_data.Page_12_Index = Page_Count_12;

        string Page_12_Text_jsonData = JsonUtility.ToJson(Page_12_Text_data);
        PlayerPrefs.SetString("Page_12_1_Text", Page_12_Text_jsonData);
        PlayerPrefs.Save();

        //13번
        GameData_Side_Story_1_1 Page_13_Text_data = new GameData_Side_Story_1_1();
        Page_13_Text_data.Page_13_Index = Page_Count_13;

        string Page_13_Text_jsonData = JsonUtility.ToJson(Page_13_Text_data);
        PlayerPrefs.SetString("Page_13_1_Text", Page_13_Text_jsonData);
        PlayerPrefs.Save();

        //14번
        GameData_Side_Story_1_1 Page_14_Text_data = new GameData_Side_Story_1_1();
        Page_14_Text_data.Page_14_Index = Page_Count_14;

        string Page_14_Text_jsonData = JsonUtility.ToJson(Page_14_Text_data);
        PlayerPrefs.SetString("Page_14_1_Text", Page_14_Text_jsonData);
        PlayerPrefs.Save();

        //15번 페이지
        GameData_Side_Story_1_1 Page_15_Text_data = new GameData_Side_Story_1_1();
        Page_15_Text_data.Page_15_Index = Page_Count_15;

        string Page_15_Text_jsonData = JsonUtility.ToJson(Page_15_Text_data);
        PlayerPrefs.SetString("Page_15_1_Text", Page_15_Text_jsonData);
        PlayerPrefs.Save();

        //16번
        GameData_Side_Story_1_1 Page_16_Text_data = new GameData_Side_Story_1_1();
        Page_16_Text_data.Page_16_Index = Page_Count_16;

        string Page_16_Text_jsonData = JsonUtility.ToJson(Page_16_Text_data);
        PlayerPrefs.SetString("Page_16_1_Text", Page_16_Text_jsonData);
        PlayerPrefs.Save();

        //17번
        GameData_Side_Story_1_1 Page_17_Text_data = new GameData_Side_Story_1_1();
        Page_17_Text_data.Page_17_Index = Page_Count_17;

        string Page_17_Text_jsonData = JsonUtility.ToJson(Page_17_Text_data);
        PlayerPrefs.SetString("Page_17_1_Text", Page_17_Text_jsonData);
        PlayerPrefs.Save();
    ...
    public void Side_Story_1_1_ResetSettings()
    {
        ...
        */
        ...
        //여기부터는 첫 번째 이야기의 몇 번째 페이지에서 저장했는지
        PlayerPrefs.DeleteKey("SideStory_1_1_What_Page");
        PlayerPrefs.Save();
        ...
        PlayerPrefs.DeleteKey("Page_5_1_Text");
        PlayerPrefs.Save();
        ...
        //6
        PlayerPrefs.DeleteKey("Page_6_1_Text");
        PlayerPrefs.Save();
        ...
        //7
        PlayerPrefs.DeleteKey("Page_7_1_Text");
        PlayerPrefs.Save();
        ...
        //8
        PlayerPrefs.DeleteKey("Page_8_1_Text");
        PlayerPrefs.Save();
        ...
        //9
        PlayerPrefs.DeleteKey("Page_9_1_Text");
        PlayerPrefs.Save();
        ...
        //10
        PlayerPrefs.DeleteKey("Page_10_1_Text");
        PlayerPrefs.Save();
        ...
        //11
        PlayerPrefs.DeleteKey("Page_11_1_Text");
        PlayerPrefs.Save();
        ...
        //12
        PlayerPrefs.DeleteKey("Page_12_1_Text");
        PlayerPrefs.Save();
        ...
        //13
        PlayerPrefs.DeleteKey("Page_13_1_Text");
        PlayerPrefs.Save();
        ...
        //14
        PlayerPrefs.DeleteKey("Page_14_1_Text");
        PlayerPrefs.Save();
        ...
        //15
        PlayerPrefs.DeleteKey("Page_15_1_Text");
        PlayerPrefs.Save();
        ...
        //16
        PlayerPrefs.DeleteKey("Page_16_1_Text");
        PlayerPrefs.Save();
        ...
        //17
        PlayerPrefs.DeleteKey("Page_17_1_Text");
        PlayerPrefs.Save();
    ...
    private void Page_5_Text_LoadSettings()
    {
        ...
        //5페이지 몇 번째 텍스트 나왔는지
        if (PlayerPrefs.HasKey("Page_5_1_Text"))
        {
            string Page_5_Text_jsonData = PlayerPrefs.GetString("Page_5_1_Text");
            GameData_Side_Story_1_1 Page_5_Text_data = JsonUtility.FromJson<GameData_Side_Story_1_1>(Page_5_Text_jsonData);
    ...
    {
        //5페이지 몇 번째 텍스트 나왔는지
        if (PlayerPrefs.HasKey("Page_6_1_Text"))
        {
            string Page_6_Text_jsonData = PlayerPrefs.GetString("Page_6_1_Text");
            GameData_Side_Story_1_1 Page_6_Text_data = JsonUtility.FromJson<GameData_Side_Story_1_1>(Page_6_Text_jsonData);
    ...
    {
        //5페이지 몇 번째 텍스트 나왔는지
        if (PlayerPrefs.HasKey("Page_7_1_Text"))
        {
            string Page_7_Text_jsonData = PlayerPrefs.GetString("Page_7_1_Text");
            GameData_Side_Story_1_1 Page_7_Text_data = JsonUtility.FromJson<GameData_Side_Story_1_1>(Page_7_Text_jsonData);
    ...
    {
        //5페이지 몇 번째 텍스트 나왔는지
        if (PlayerPrefs.HasKey("Page_8_1_Text"))
        {
            string Page_8_Text_jsonData = PlayerPrefs.GetString("Page_8_1_Text");
            GameData_Side_Story_1_1 Page_8_Text_data = JsonUtility.FromJson<GameData_Side_Story_1_1>(Page_8_Text_jsonData);
    ...
    {
        //5페이지 몇 번째 텍스트 나왔는지
        if (PlayerPrefs.HasKey("Page_9_1_Text"))
        {
            string Page_9_Text_jsonData = PlayerPrefs.GetString("Page_9_1_Text");
            GameData_Side_Story_1_1 Page_9_Text_data = JsonUtility.FromJson<GameData_Side_Story_1_1>(Page_9_Text_jsonData);
    ...
    {
        //5페이지 몇 번째 텍스트 나왔는지
        if (PlayerPrefs.HasKey("Page_10_1_Text"))
        {
            string Page_10_Text_jsonData = PlayerPrefs.GetString("Page_10_1_Text");
            GameData_Side_Story_1_1 Page_10_Text_data = JsonUtility.FromJson<GameData_Side_Story_1_1>(Page_10_Text_jsonData);
    ...
    {
        //5페이지 몇 번째 텍스트 나왔는지
        if (PlayerPrefs.HasKey("Page_11_1_Text"))
        {
            string Page_11_Text_jsonData = PlayerPrefs.GetString("Page_11_1_Text");
            GameData_Side_Story_1_1 Page_11_Text_data = JsonUtility.FromJson<GameData_Side_Story_1_1>(Page_11_Text_jsonData);
    ...
    {
        //5페이지 몇 번째 텍스트 나왔는지
        if (PlayerPrefs.HasKey("Page_12_1_Text"))
        {
            string Page_12_Text_jsonData = PlayerPrefs.GetString("Page_12_1_Text");
            GameData_Side_Story_1_1 Page_12_Text_data = JsonUtility.FromJson<GameData_Side_Story_1_1>(Page_12_Text_jsonData);
    ...
    {
        //5페이지 몇 번째 텍스트 나왔는지
        if (PlayerPrefs.HasKey("Page_13_1_Text"))
        {
            string Page_13_Text_jsonData = PlayerPrefs.GetString("Page_13_1_Text");
            GameData_Side_Story_1_1 Page_13_Text_data = JsonUtility.FromJson<GameData_Side_Story_1_1>(Page_13_Text_jsonData);
    ...
    {
        //5페이지 몇 번째 텍스트 나왔는지
        if (PlayerPrefs.HasKey("Page_14_1_Text"))
        {
            string Page_14_Text_jsonData = PlayerPrefs.GetString("Page_14_1_Text");
            GameData_Side_Story_1_1 Page_14_Text_data = JsonUtility.FromJson<GameData_Side_Story_1_1>(Page_14_Text_jsonData);
    ...
    {
        //5페이지 몇 번째 텍스트 나왔는지
        if (PlayerPrefs.HasKey("Page_15_1_Text"))
        {
            string Page_15_Text_jsonData = PlayerPrefs.GetString("Page_15_1_Text");
            GameData_Side_Story_1_1 Page_15_Text_data = JsonUtility.FromJson<GameData_Side_Story_1_1>(Page_15_Text_jsonData);
    ...
    {
        //5페이지 몇 번째 텍스트 나왔는지
        if (PlayerPrefs.HasKey("Page_16_1_Text"))
        {
            string Page_16_Text_jsonData = PlayerPrefs.GetString("Page_16_1_Text");
            GameData_Side_Story_1_1 Page_16_Text_data = JsonUtility.FromJson<GameData_Side_Story_1_1>(Page_16_Text_jsonData);
    ...
    {
        //5페이지 몇 번째 텍스트 나왔는지
        if (PlayerPrefs.HasKey("Page_17_1_Text"))
        {
            string Page_17_Text_jsonData = PlayerPrefs.GetString("Page_17_1_Text");
            GameData_Side_Story_1_1 Page_17_Text_data = JsonUtility.FromJson<GameData_Side_Story_1_1>(Page_17_Text_jsonData);
