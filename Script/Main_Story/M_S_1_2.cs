...
public class GameData_Main_Story_1_2_R
...
public class M_S_1_2 : MonoBehaviour
{
    ...
    public void Update()
    {
        ...
        //2번 앨범
        if (Page_13[5].activeSelf == true || m_s_1_1.Page_13[5].activeSelf == true)
        {
            album.Album_2[0].SetActive(false);
            album.Album_2[1].SetActive(true);
        }

        if (Page_13[5].activeSelf == false && m_s_1_1.Page_13[5].activeSelf == false)
        {
        ...
        //3번 앨범
        if (Page_20[0].activeSelf == true || m_s_1_1.Page_20[0].activeSelf == true)
        {
            album.Album_3[0].SetActive(false);
            album.Album_3[1].SetActive(true);
        }

        if (Page_20[0].activeSelf == false && m_s_1_1.Page_20[0].activeSelf == false)
        {
            //19페이지까지 다 보지 못했을 때
        ...
        //편지2번째
        if (Page_22[4].activeSelf == true || m_s_1_1.Page_22[4].activeSelf == true)
        {
            letter.Two_Letter.SetActive(true);
        }

        if (Page_22[4].activeSelf == false&& m_s_1_1.Page_22[4].activeSelf == true)
        {
    ...
    private void Main_Story_1_1What_Page_LoadSettings()
    {
        ...
        if (PlayerPrefs.HasKey("Main_Story_1_2_What_Page"))
        {
            string What_Page_First_Page_jsonData_1 = PlayerPrefs.GetString("Main_Story_1_2_What_Page");
            GameData_Main_Story_1_2_R What_Page_First_Page_data_1 = JsonUtility.FromJson<GameData_Main_Story_1_2_R>(What_Page_First_Page_jsonData_1);
    ...
    private void Main_Story_1_1_SaveSettings()//일단 첫 번째 사이드 스토리의 몇 번째인지(1, 1-1, 1-2중)
    {
        ...
        GameData_Main_Story_1_2_R data = new GameData_Main_Story_1_2_R();
        data.First_Main_Story = First_Main_Story_Object_Index;

        string jsonData = JsonUtility.ToJson(data);
        PlayerPrefs.SetString("Main_Story_1_2", jsonData);
        PlayerPrefs.Save();


        //여기부터는 첫 번째 이야기의 몇 번째 페이지에서 저장했는지
        GameData_Main_Story_1_2_R What_Page_First_Page_data_1 = new GameData_Main_Story_1_2_R();
        ...
        PlayerPrefs.SetString("Main_Story_1_2_What_Page", What_Page_First_Page_jsonData_1);
        PlayerPrefs.Save();
        ...
        //10번 페이지
        GameData_Main_Story_1_2_R Page_10_Text_data = new GameData_Main_Story_1_2_R();
        Page_10_Text_data.Page_10_Index = Page_Count_10;

        string Page_10_Text_jsonData = JsonUtility.ToJson(Page_10_Text_data);
        PlayerPrefs.SetString("Main_Story_1_2_Page_10_Text", Page_10_Text_jsonData);
        PlayerPrefs.Save();

        //11번
        GameData_Main_Story_1_2_R Page_11_Text_data = new GameData_Main_Story_1_2_R();
        Page_11_Text_data.Page_11_Index = Page_Count_11;

        string Page_11_Text_jsonData = JsonUtility.ToJson(Page_11_Text_data);
        PlayerPrefs.SetString("Main_Story_1_2_Page_11_Text", Page_11_Text_jsonData);
        PlayerPrefs.Save();

        //12번
        GameData_Main_Story_1_2_R Page_12_Text_data = new GameData_Main_Story_1_2_R();
        Page_12_Text_data.Page_12_Index = Page_Count_12;

        string Page_12_Text_jsonData = JsonUtility.ToJson(Page_12_Text_data);
        PlayerPrefs.SetString("Main_Story_1_2_Page_12_Text", Page_12_Text_jsonData);
        PlayerPrefs.Save();

        //13번
        GameData_Main_Story_1_2_R Page_13_Text_data = new GameData_Main_Story_1_2_R();
        Page_13_Text_data.Page_13_Index = Page_Count_13;

        string Page_13_Text_jsonData = JsonUtility.ToJson(Page_13_Text_data);
        PlayerPrefs.SetString("Main_Story_1_2_Page_13_Text", Page_13_Text_jsonData);
        PlayerPrefs.Save();

        //14번
        GameData_Main_Story_1_2_R Page_14_Text_data = new GameData_Main_Story_1_2_R();
        Page_14_Text_data.Page_14_Index = Page_Count_14;

        string Page_14_Text_jsonData = JsonUtility.ToJson(Page_14_Text_data);
        PlayerPrefs.SetString("Main_Story_1_2_Page_14_Text", Page_14_Text_jsonData);
        PlayerPrefs.Save();

        //15번 페이지
        GameData_Main_Story_1_2_R Page_15_Text_data = new GameData_Main_Story_1_2_R();
        Page_15_Text_data.Page_15_Index = Page_Count_15;

        string Page_15_Text_jsonData = JsonUtility.ToJson(Page_15_Text_data);
        PlayerPrefs.SetString("Main_Story_1_2_Page_15_Text", Page_15_Text_jsonData);
        PlayerPrefs.Save();

        //16번
        GameData_Main_Story_1_2_R Page_16_Text_data = new GameData_Main_Story_1_2_R();
        Page_16_Text_data.Page_16_Index = Page_Count_16;

        string Page_16_Text_jsonData = JsonUtility.ToJson(Page_16_Text_data);
        PlayerPrefs.SetString("Main_Story_1_2_Page_16_Text", Page_16_Text_jsonData);
        PlayerPrefs.Save();

        //17번
        GameData_Main_Story_1_2_R Page_17_Text_data = new GameData_Main_Story_1_2_R();
        Page_17_Text_data.Page_17_Index = Page_Count_17;

        string Page_17_Text_jsonData = JsonUtility.ToJson(Page_17_Text_data);
        PlayerPrefs.SetString("Main_Story_1_2_Page_17_Text", Page_17_Text_jsonData);
        PlayerPrefs.Save();

        //18번
        GameData_Main_Story_1_2_R Page_18_Text_data = new GameData_Main_Story_1_2_R();
        Page_18_Text_data.Page_18_Index = Page_Count_18;

        string Page_18_Text_jsonData = JsonUtility.ToJson(Page_18_Text_data);
        PlayerPrefs.SetString("Main_Story_1_2_Page_18_Text", Page_18_Text_jsonData);
        PlayerPrefs.Save();

        //19번
        GameData_Main_Story_1_2_R Page_19_Text_data = new GameData_Main_Story_1_2_R();
        Page_19_Text_data.Page_19_Index = Page_Count_19;

        string Page_19_Text_jsonData = JsonUtility.ToJson(Page_19_Text_data);
        PlayerPrefs.SetString("Main_Story_1_2_Page_19_Text", Page_19_Text_jsonData);
        PlayerPrefs.Save();

        //20번 페이지
        GameData_Main_Story_1_2_R Page_20_Text_data = new GameData_Main_Story_1_2_R();
        Page_20_Text_data.Page_20_Index = Page_Count_20;

        string Page_20_Text_jsonData = JsonUtility.ToJson(Page_20_Text_data);
        PlayerPrefs.SetString("Main_Story_1_2_Page_20_Text", Page_20_Text_jsonData);
        PlayerPrefs.Save();

        //21번
        GameData_Main_Story_1_2_R Page_21_Text_data = new GameData_Main_Story_1_2_R();
        Page_21_Text_data.Page_21_Index = Page_Count_21;

        string Page_21_Text_jsonData = JsonUtility.ToJson(Page_21_Text_data);
        PlayerPrefs.SetString("Main_Story_1_2_Page_21_Text", Page_21_Text_jsonData);
        PlayerPrefs.Save();

        //22번
        GameData_Main_Story_1_2_R Page_22_Text_data = new GameData_Main_Story_1_2_R();
        Page_22_Text_data.Page_22_Index = Page_Count_22;

        string Page_22_Text_jsonData = JsonUtility.ToJson(Page_22_Text_data);
        PlayerPrefs.SetString("Main_Story_1_2_Page_22_Text", Page_22_Text_jsonData);
        PlayerPrefs.Save();

        //23
        GameData_Main_Story_1_2_R Page_23_Text_data = new GameData_Main_Story_1_2_R();
        Page_23_Text_data.Page_23_Index = Page_Count_23;

        string Page_23_Text_jsonData = JsonUtility.ToJson(Page_23_Text_data);
        PlayerPrefs.SetString("Main_Story_1_2_Page_23_Text", Page_23_Text_jsonData);
        PlayerPrefs.Save();

        //14번
        GameData_Main_Story_1_2_R Page_24_Text_data = new GameData_Main_Story_1_2_R();
        Page_24_Text_data.Page_24_Index = Page_Count_24;

        string Page_24_Text_jsonData = JsonUtility.ToJson(Page_24_Text_data);
        PlayerPrefs.SetString("Main_Story_1_2_Page_24_Text", Page_24_Text_jsonData);
        PlayerPrefs.Save();

        //15번 페이지
        GameData_Main_Story_1_2_R Page_25_Text_data = new GameData_Main_Story_1_2_R();
        Page_25_Text_data.Page_25_Index = Page_Count_25;

        string Page_25_Text_jsonData = JsonUtility.ToJson(Page_25_Text_data);
        PlayerPrefs.SetString("Main_Story_1_2_Page_25_Text", Page_25_Text_jsonData);
        PlayerPrefs.Save();

        //16번
        GameData_Main_Story_1_2_R Page_26_Text_data = new GameData_Main_Story_1_2_R();
        Page_26_Text_data.Page_26_Index = Page_Count_26;

        string Page_26_Text_jsonData = JsonUtility.ToJson(Page_26_Text_data);
        PlayerPrefs.SetString("Main_Story_1_2_Page_26_Text", Page_26_Text_jsonData);
        PlayerPrefs.Save();

        //17번
        GameData_Main_Story_1_2_R Page_27_Text_data = new GameData_Main_Story_1_2_R();
        Page_27_Text_data.Page_27_Index = Page_Count_27;

        string Page_27_Text_jsonData = JsonUtility.ToJson(Page_27_Text_data);
        PlayerPrefs.SetString("Main_Story_1_2_Page_27_Text", Page_27_Text_jsonData);
        PlayerPrefs.Save();

        //18번
        GameData_Main_Story_1_2_R Page_28_Text_data = new GameData_Main_Story_1_2_R();
        Page_28_Text_data.Page_28_Index = Page_Count_28;

        string Page_28_Text_jsonData = JsonUtility.ToJson(Page_28_Text_data);
        PlayerPrefs.SetString("Main_Story_1_2_Page_28_Text", Page_28_Text_jsonData);
        PlayerPrefs.Save();

        //19번
        GameData_Main_Story_1_2_R Page_29_Text_data = new GameData_Main_Story_1_2_R();
        Page_29_Text_data.Page_29_Index = Page_Count_29;

        string Page_29_Text_jsonData = JsonUtility.ToJson(Page_29_Text_data);
        PlayerPrefs.SetString("Main_Story_1_2_Page_29_Text", Page_29_Text_jsonData);
        PlayerPrefs.Save();
    ...
    public void Side_Story_1_1_ResetSettings()
    {
        ...
        */
        ...
        //여기부터는 첫 번째 이야기의 몇 번째 페이지에서 저장했는지
        PlayerPrefs.DeleteKey("Main_Story_1_2_What_Page");
        PlayerPrefs.Save();
        ...
        PlayerPrefs.DeleteKey("Main_Story_1_2_Page_10_Text");
        PlayerPrefs.Save();
        ...
        //6
        PlayerPrefs.DeleteKey("Main_Story_1_2_Page_11_Text");
        PlayerPrefs.Save();
        ...
        //12
        PlayerPrefs.DeleteKey("Main_Story_1_2_Page_12_Text");
        PlayerPrefs.Save();
        ...
        //13
        PlayerPrefs.DeleteKey("Main_Story_1_2_Page_13_Text");
        PlayerPrefs.Save();
        ...
        //9
        PlayerPrefs.DeleteKey("Main_Story_1_2_Page_14_Text");
        PlayerPrefs.Save();
        ...
        //10
        PlayerPrefs.DeleteKey("Main_Story_1_2_Page_15_Text");
        PlayerPrefs.Save();
        ...
        //11
        PlayerPrefs.DeleteKey("Main_Story_1_2_Page_16_Text");
        PlayerPrefs.Save();
        ...
        //17
        PlayerPrefs.DeleteKey("Main_Story_1_2_Page_17_Text");
        PlayerPrefs.Save();
        ...
        //18
        PlayerPrefs.DeleteKey("Main_Story_1_2_Page_18_Text");
        PlayerPrefs.Save();
        ...
        //14
        PlayerPrefs.DeleteKey("Main_Story_1_2_Page_19_Text");
        PlayerPrefs.Save();
        ...
        //15
        PlayerPrefs.DeleteKey("Main_Story_1_2_Page_20_Text");
        PlayerPrefs.Save();
        ...
        //21
        PlayerPrefs.DeleteKey("Main_Story_1_2_Page_21_Text");
        PlayerPrefs.Save();
        ...
        //22
        PlayerPrefs.DeleteKey("Main_Story_1_2_Page_22_Text");
        PlayerPrefs.Save();
        ...
        //23
        PlayerPrefs.DeleteKey("Main_Story_1_2_Page_23_Text");
        PlayerPrefs.Save();
        ...
        //9
        PlayerPrefs.DeleteKey("Main_Story_1_2_Page_24_Text");
        PlayerPrefs.Save();
        ...
        //10
        PlayerPrefs.DeleteKey("Main_Story_1_2_Page_25_Text");
        PlayerPrefs.Save();
        ...
        //11
        PlayerPrefs.DeleteKey("Main_Story_1_2_Page_26_Text");
        PlayerPrefs.Save();
        ...
        //17
        PlayerPrefs.DeleteKey("Main_Story_1_2_Page_27_Text");
        PlayerPrefs.Save();
        ...
        //18
        PlayerPrefs.DeleteKey("Main_Story_1_2_Page_28_Text");
        PlayerPrefs.Save();
        ...
        //14
        PlayerPrefs.DeleteKey("Main_Story_1_2_Page_29_Text");
        PlayerPrefs.Save();
    ...
    private void Page_10_Text_LoadSettings()
    {
        ...
        //5페이지 몇 번째 텍스트 나왔는지
        if (PlayerPrefs.HasKey("Main_Story_1_2_Page_10_Text"))
        {
            string Page_10_Text_jsonData = PlayerPrefs.GetString("Main_Story_1_2_Page_10_Text");
            GameData_Main_Story_1_2_R Page_10_Text_data = JsonUtility.FromJson<GameData_Main_Story_1_2_R>(Page_10_Text_jsonData);
    ...
    {
        //5페이지 몇 번째 텍스트 나왔는지
        if (PlayerPrefs.HasKey("Main_Story_1_2_Page_11_Text"))
        {
            string Page_11_Text_jsonData = PlayerPrefs.GetString("Main_Story_1_2_Page_11_Text");
            GameData_Main_Story_1_2_R Page_11_Text_data = JsonUtility.FromJson<GameData_Main_Story_1_2_R>(Page_11_Text_jsonData);
    ...
    {
        //5페이지 몇 번째 텍스트 나왔는지
        if (PlayerPrefs.HasKey("Main_Story_1_2_Page_12_Text"))
        {
            string Page_12_Text_jsonData = PlayerPrefs.GetString("Main_Story_1_2_Page_12_Text");
            GameData_Main_Story_1_2_R Page_12_Text_data = JsonUtility.FromJson<GameData_Main_Story_1_2_R>(Page_12_Text_jsonData);
    ...
    {
        //5페이지 몇 번째 텍스트 나왔는지
        if (PlayerPrefs.HasKey("Main_Story_1_2_Page_13_Text"))
        {
            string Page_13_Text_jsonData = PlayerPrefs.GetString("Main_Story_1_2_Page_13_Text");
            GameData_Main_Story_1_2_R Page_13_Text_data = JsonUtility.FromJson<GameData_Main_Story_1_2_R>(Page_13_Text_jsonData);
    ...
    {
        //5페이지 몇 번째 텍스트 나왔는지
        if (PlayerPrefs.HasKey("Main_Story_1_2_Page_14_Text"))
        {
            string Page_14_Text_jsonData = PlayerPrefs.GetString("Main_Story_1_2_Page_14_Text");
            GameData_Main_Story_1_2_R Page_14_Text_data = JsonUtility.FromJson<GameData_Main_Story_1_2_R>(Page_14_Text_jsonData);
    ...
    {
        //5페이지 몇 번째 텍스트 나왔는지
        if (PlayerPrefs.HasKey("Main_Story_1_2_Page_15_Text"))
        {
            string Page_15_Text_jsonData = PlayerPrefs.GetString("Main_Story_1_2_Page_15_Text");
            GameData_Main_Story_1_2_R Page_15_Text_data = JsonUtility.FromJson<GameData_Main_Story_1_2_R>(Page_15_Text_jsonData);
    ...
    {
        //5페이지 몇 번째 텍스트 나왔는지
        if (PlayerPrefs.HasKey("Main_Story_1_2_Page_16_Text"))
        {
            string Page_16_Text_jsonData = PlayerPrefs.GetString("Main_Story_1_2_Page_16_Text");
            GameData_Main_Story_1_2_R Page_16_Text_data = JsonUtility.FromJson<GameData_Main_Story_1_2_R>(Page_16_Text_jsonData);
    ...
    {
        //5페이지 몇 번째 텍스트 나왔는지
        if (PlayerPrefs.HasKey("Main_Story_1_2_Page_17_Text"))
        {
            string Page_17_Text_jsonData = PlayerPrefs.GetString("Main_Story_1_2_Page_17_Text");
            GameData_Main_Story_1_2_R Page_17_Text_data = JsonUtility.FromJson<GameData_Main_Story_1_2_R>(Page_17_Text_jsonData);
    ...
    {
        //5페이지 몇 번째 텍스트 나왔는지
        if (PlayerPrefs.HasKey("Main_Story_1_2_Page_18_Text"))
        {
            string Page_18_Text_jsonData = PlayerPrefs.GetString("Main_Story_1_2_Page_18_Text");
            GameData_Main_Story_1_2_R Page_18_Text_data = JsonUtility.FromJson<GameData_Main_Story_1_2_R>(Page_18_Text_jsonData);
    ...
    {
        //5페이지 몇 번째 텍스트 나왔는지
        if (PlayerPrefs.HasKey("Main_Story_1_2_Page_19_Text"))
        {
            string Page_19_Text_jsonData = PlayerPrefs.GetString("Main_Story_1_2_Page_19_Text");
            GameData_Main_Story_1_2_R Page_19_Text_data = JsonUtility.FromJson<GameData_Main_Story_1_2_R>(Page_19_Text_jsonData);
    ...
    {
        //5페이지 몇 번째 텍스트 나왔는지
        if (PlayerPrefs.HasKey("Main_Story_1_2_Page_20_Text"))
        {
            string Page_20_Text_jsonData = PlayerPrefs.GetString("Main_Story_1_2_Page_20_Text");
            GameData_Main_Story_1_2_R Page_20_Text_data = JsonUtility.FromJson<GameData_Main_Story_1_2_R>(Page_20_Text_jsonData);
    ...
    {
        //5페이지 몇 번째 텍스트 나왔는지
        if (PlayerPrefs.HasKey("Main_Story_1_2_Page_21_Text"))
        {
            string Page_21_Text_jsonData = PlayerPrefs.GetString("Main_Story_1_2_Page_21_Text");
            GameData_Main_Story_1_2_R Page_21_Text_data = JsonUtility.FromJson<GameData_Main_Story_1_2_R>(Page_21_Text_jsonData);
    ...
    {
        //5페이지 몇 번째 텍스트 나왔는지
        if (PlayerPrefs.HasKey("Main_Story_1_2_Page_22_Text"))
        {
            string Page_22_Text_jsonData = PlayerPrefs.GetString("Main_Story_1_2_Page_22_Text");
            GameData_Main_Story_1_2_R Page_22_Text_data = JsonUtility.FromJson<GameData_Main_Story_1_2_R>(Page_22_Text_jsonData);
    ...
    {
        //5페이지 몇 번째 텍스트 나왔는지
        if (PlayerPrefs.HasKey("Main_Story_1_2_Page_23_Text"))
        {
            string Page_23_Text_jsonData = PlayerPrefs.GetString("Main_Story_1_2_Page_23_Text");
            GameData_Main_Story_1_2_R Page_23_Text_data = JsonUtility.FromJson<GameData_Main_Story_1_2_R>(Page_23_Text_jsonData);
    ...
    {
        //5페이지 몇 번째 텍스트 나왔는지
        if (PlayerPrefs.HasKey("Main_Story_1_2_Page_24_Text"))
        {
            string Page_24_Text_jsonData = PlayerPrefs.GetString("Main_Story_1_2_Page_24_Text");
            GameData_Main_Story_1_2_R Page_24_Text_data = JsonUtility.FromJson<GameData_Main_Story_1_2_R>(Page_24_Text_jsonData);
    ...
    {
        //5페이지 몇 번째 텍스트 나왔는지
        if (PlayerPrefs.HasKey("Main_Story_1_2_Page_25_Text"))
        {
            string Page_25_Text_jsonData = PlayerPrefs.GetString("Main_Story_1_2_Page_25_Text");
            GameData_Main_Story_1_2_R Page_25_Text_data = JsonUtility.FromJson<GameData_Main_Story_1_2_R>(Page_25_Text_jsonData);
    ...
    {
        //5페이지 몇 번째 텍스트 나왔는지
        if (PlayerPrefs.HasKey("Main_Story_1_2_Page_26_Text"))
        {
            string Page_26_Text_jsonData = PlayerPrefs.GetString("Main_Story_1_2_Page_26_Text");
            GameData_Main_Story_1_2_R Page_26_Text_data = JsonUtility.FromJson<GameData_Main_Story_1_2_R>(Page_26_Text_jsonData);
    ...
    {
        //5페이지 몇 번째 텍스트 나왔는지
        if (PlayerPrefs.HasKey("Main_Story_1_2_Page_27_Text"))
        {
            string Page_27_Text_jsonData = PlayerPrefs.GetString("Main_Story_1_2_Page_27_Text");
            GameData_Main_Story_1_2_R Page_27_Text_data = JsonUtility.FromJson<GameData_Main_Story_1_2_R>(Page_27_Text_jsonData);
    ...
    {
        //5페이지 몇 번째 텍스트 나왔는지
        if (PlayerPrefs.HasKey("Main_Story_1_2_Page_28_Text"))
        {
            string Page_28_Text_jsonData = PlayerPrefs.GetString("Main_Story_1_2_Page_28_Text");
            GameData_Main_Story_1_2_R Page_28_Text_data = JsonUtility.FromJson<GameData_Main_Story_1_2_R>(Page_28_Text_jsonData);
    ...
    {
        //5페이지 몇 번째 텍스트 나왔는지
        if (PlayerPrefs.HasKey("Main_Story_1_2_Page_29_Text"))
        {
            string Page_29_Text_jsonData = PlayerPrefs.GetString("Main_Story_1_2_Page_29_Text");
            GameData_Main_Story_1_2_R Page_29_Text_data = JsonUtility.FromJson<GameData_Main_Story_1_2_R>(Page_29_Text_jsonData);
